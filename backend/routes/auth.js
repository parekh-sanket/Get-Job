          ...
          transporter
            ...
            .then(() => {
              ...
              res.json({
                ...
                status: "PENDING",
                message:
                  "Please check your Inbox, we have sent you verification mail!",
              });
            })
            .catch((error) => {
  ...
  UserVerification.find({userId})
    .then((result) => {
      if (result.length > 0) {
        ...
        let message =
          "Account record does not exist or has been verified already, Please log in.";
        console.log(message);
      }
    })
    .catch(() => {
              ...
              transporter
                ...
                .then(() => {
                  ...
                  res.json({
                    ...
                    status: "PENDING",
                    message:
                      "Please Check your Inbox, We have sent you Reset Password mail!",
                  });
                })
                .catch((error) => {
                  console.error(error);
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (user) {
        return res
          ...
          .json({
            success: false,
            error: [],
            warning: "Sorry a user with this email already exists.",
          });
      }
      ...
      res
        .status(500)
        .send({success: false, error: [], warning: "Some error occured"});
    }
  }
);
      ...
      if (!user) {
        return res
          ...
          .json({
            success: false,
            error: [],
            warning: "Sorry Invalid credentials",
          });
        ...
        return res
          ...
          .json({
            success: false,
            error: [],
            warning: "Plese Verify your email!!",
          });
      }
